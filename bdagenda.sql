...
ADD CONSTRAINT fk_agenda_distrito FOREIGN KEY (id_distrito) REFERENCES distrito(id_distrito);

-- Insertar datos en la tabla distrito
INSERT INTO distrito (nombre) VALUES ('Chimbote'),
('Lima');
COMMIT;
...
-- actualizo la tabla agenda
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '1';
UPDATE agenda SET id_distrito = 2 WHERE codigoper = '2';
UPDATE agenda SET id_distrito = 2 WHERE codigoper = '3';
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '4';
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '5';
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '6';
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '7';
UPDATE agenda SET id_distrito = 1 WHERE codigoper = '8';
UPDATE agenda SET id_distrito = 2 WHERE codigoper = '9';
UPDATE agenda SET id_distrito = 2 WHERE codigoper = '10';
